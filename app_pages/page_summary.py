...
def page_summary_body():
    ...
    st.info(
        ...
        f"* Mildew is a fungus that can infect the leaves of the cherry tree."
        f"A leaf from the cherry tree is collected. Visual criteria are used to detect mildew infection."
        f"The mildew infection is devastating to the cherry tree farmers and takes a lot of time for the farm workers to detect and handle project Dataset"
